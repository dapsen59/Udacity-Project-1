...
def process_log_file(cur, filepath):
    ...
    # load user table
    user_df = pd.DataFrame({'userid':df.userId,'firstName':
    df.firstName,'lastName':df.lastName,'gender':df.gender,'level':df.level})
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = for index, row in df.iterrows():
